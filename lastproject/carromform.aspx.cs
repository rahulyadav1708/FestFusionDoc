...
public partial class carromform : System.Web.UI.Page
{
    ...
    // Method to fetch the game name from the database
    private string GetGameNameFromDatabase()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            command.Parameters.AddWithValue("@ID", 1); // Assuming game ID for "Carrom" is 1
