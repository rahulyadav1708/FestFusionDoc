<%@ Page Title="" Language="C#" MasterPageFile="~/master.master" AutoEventWireup="true" CodeFile="openmic.aspx.cs" Inherits="openmic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <img   class="slide_image" src="img/Open Mic.png" />
    ...
    <h2 id="mtext">OPEN MIC</h2>
    <br />

    <p style="font-size:23px;margin-left:100px;margin-right:100px;">"Open mics are the heartbeat of expression, where every voice, every note, and every word is a melody in the symphony of creativity."<br /><br />
        Open mic events provide a platform for artists, performers, and creators to share their talents with a live audience. These gatherings celebrate the diversity of artistic expression and often feature music, poetry, comedy, storytelling, and more. 
    On the open mic stage, silence is an empty canvas waiting to be filled with the colors of courage, melody, and the spoken word.</p>
    <br />
    ...
    <ol style="font-size:21px;">
        <li>The open mic is open to participants of all skill levels and backgrounds.</li>
        <br /><li>Participants must register in advance through the event website or on-site
by registration process and deadline.</li>
        <br /><li>Each performer is allowed a maximum time limit of 6 minutes.
</li><br />
        <li>Consequences for disruptive behavior or any form of harassment should be clearly outlined.</li><br />
